...
return [
   ...
   */
  'queue_name' => env('MEDIA_LIBRARY_QUEUE_NAME', 'media-library'),
  ...
  /*
   * The path where to store media files.
   */
  'media_path' => 'media',
  ...
  /*
   * When enabled, media collections will be serialized to json when saved.
   */
  'enable_media_serialization' => true,
